	  ...
	  _createClass(pool, [{
	    ...
	    value: function addWorkToPending(index, task, resolve, reject) {
	      if (_habitat2.default.debug) {
	        var _threads = task.scheduler.metrics.threads;
	    ...
	    */
	    ...
	    value: function processQueuedItem(hamster, item) {
	      if (_habitat2.default.debug) {
	        var _threads2 = item.task.scheduler.metrics.threads;
	        var thread = _threads2[item.count];
	    ...
	    */
	    ...
	    value: function keepTrackOfThread(task, id) {
	      if (_habitat2.default.debug) {
	        var _threads3 = task.scheduler.metrics.threads;
	        var thread = _threads3[_threads3.length - 1];
