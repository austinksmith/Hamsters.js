	    ...
	    */
	    ...
	    value: function processStartOptions(startOptions) {
	      ...
	      if (typeof startOptions !== 'undefined') {
	        ...
	        var habitatKeys = ['worker', 'sharedworker', 'legacy', 'webworker', 'reactnative', 'atomics', 'proxies', 'transferrable', 'browser', 'shell', 'node', 'debug', 'persistence', 'importscripts', 'maxThreads'];
	        var key = null;
