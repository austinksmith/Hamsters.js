	  ...
	  */
	  ...
	  _createClass(Pool, [{
	    ...
	    */
	    ...
	    key: 'trainHamster',
	    value: function trainHamster(index, subTaskId, task, threadId, hamster, resolve, reject) {
	      var _this = this;
	
	      var onThreadResponse = function onThreadResponse(message) {
	        _this.hamsters.pool.processReturn(index, message, subTaskId, task);
	        ...
	        if (_this.hamsters.pool.pending.length !== 0) {
	          return _this.hamsters.pool.processQueuedItem(hamster, _this.hamsters.pool.pending.shift());
	        }
