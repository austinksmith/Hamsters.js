	  ...
	  */
	  ...
	  _createClass(Pool, [{
	    ...
	    */
	    ...
	    value: function processQueuedItem(hamster, threadId, item) {
	      if (this.hamsters.habitat.debug) {
	    ...
	    */
	    ...
	    key: 'runTask',
	    value: function runTask(hamster, threadId, index, task, resolve, reject) {
	    ...
	    value: function trainHamster(index, task, threadId, hamster, resolve, reject) {
	      ...
	      var onThreadResponse = function onThreadResponse(message) {
	        ...
	        if (task.scheduler.workers.length === 0 && task.scheduler.count === task.scheduler.threads) {
	          _this.returnOutputAndRemoveTask(task, resolve);
	        }
	        ...
	        if (_this.hamsters.pool.pending.length !== 0) {
	          _this.hamsters.pool.processQueuedItem(hamster, threadId, _this.hamsters.pool.pending.shift());
	        }
	...
	var Data = function () {
	  ...
	  */
	  ...
	  _createClass(Data, [{
	    ...
	    value: function messageWorkerThread(hamster, hamsterFood, queued) {
