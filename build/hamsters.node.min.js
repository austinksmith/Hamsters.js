...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	var hamstersjs = function () {
	  ...
	  */
	  function hamstersjs() {
	    ...
	    this.version = _version2.default.current;
	  ...
	  */
	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function initializeLibrary(startOptions) {
	      ...
	      if (!_habitat2.default.legacy && _habitat2.default.persistence === true) {
	        _pool2.default.spawnHamsters(_habitat2.default.maxThreads);
	      }
	      _logger2.default.info('Initialized using up to ' + _habitat2.default.maxThreads + ' threads.');
	      delete this.init;
	    }
	    ...
	    */
	    ...
	    value: function processStartOptions(startOptions) {
	        ...
	        try {
	          for (var _iterator = Object.keys(startOptions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            if (habitatKeys.indexOf(key.toLowerCase()) !== -1) {
	              _habitat2.default[key] = startOptions[key];
	            } else {
	      ...
	      if (typeof _habitat2.default['Worker'] === 'function' && !legacyMode) {
	        _habitat2.default.legacy = false;
	      }
	      // Finished initializing, add methods & imports
	      this.habitat = _habitat2.default;
	      this.maxThreads = _habitat2.default.maxThreads;
	    ...
	    */
	    ...
	    value: function hamstersTask(params, functionToRun) {
	      var newHamstersTaskId = _pool2.default.tasks.length;
	      var newHamstersTask = {
	      ...
	      if (_habitat2.default.legacy) {
	        ...
	        newHamstersTask.input.hamstersJob = _data2.default.prepareJob(functionToRun);
	      }
	    ...
	    value: function scheduleTask(task, resolve, reject) {
	      _pool2.default.scheduleTask(task).then(function (results) {
	...
	exports.default = new hamstersjs();
	  ...
	  */
	  ...
	  _createClass(logger, [{
	    ...
	    value: function generateTimeStampedMessage(type, message) {
	      var record = 'Hamsters.js v' + _version2.default.current + ' ' + type + ': ' + message + ' @ ' + Date.now();
	    ...
	    */
	    ...
	    value: function spawnHamster() {
	      ...
	      if (_habitat2.default.node && typeof _habitat2.default.parentPort !== 'undefined') {
	        return new _habitat2.default.Worker();
	      }
	    ...
	    */
	    ...
	    value: function trainHamster(threadId, task, hamster, resolve, reject) {
	      ...
	      function onThreadResponse(message) {
	        ...
	        } else if (!_habitat2.default.persistence && !_habitat2.default.webWorker) {
