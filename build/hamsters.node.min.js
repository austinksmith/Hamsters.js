...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	var _memoize = __webpack_require__(6);
	  ...
	  */
	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function inititializeLibrary(startOptions) {
	      ...
	      this.memoize = new _memoize2.default(this);
	  ...
	  */
	  ...
	  _createClass(Pool, [{
	    ...
	    */
	    ...
	    key: 'processReturn',
	    value: function processReturn(index, message, threadId, task) {
	      var isReactNative = this.hamsters.habitat.reactNative;
	      var messageData = isReactNative ? JSON.parse(message).data : message.data.data !== undefined ? message.data.data : message.data;
	    ...
	    */
	    ...
	    value: function trainHamster(index, task, threadId, hamster, resolve, reject) {
	      ...
	      var onThreadResponse = function onThreadResponse(message) {
	        _this.hamsters.pool.processReturn(index, message, threadId, task);
	      ...
	      if (this.hamsters.habitat.debug) {
	        ...
	        return new Promise(function (resolve, reject) {
	          while (i < task.scheduler.threads) {
	            ...
	            _this2.hamsterWheel(task.scheduler.indexes[i], task, resolve, reject);
	            i += 1;
	          }
	        });
	      }
	...
	var Data = function () {
	  ...
	  */
	  ...
	  _createClass(Data, [{
	    ...
	    value: function messageWorkerThread(hamster, task, hamsterFood) {
	    ...
	    */
	    ...
	    value: function regularScaffold() {
	      ...
	      self.onmessage = function (message) {
	        ...
	        var buffers = handleDataType(this.rtn); // Call the function to handle data type
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NodeStore = __webpack_require__(7);
	
	var _NodeStore2 = _interopRequireDefault(_NodeStore);
	
	var _WebStore = __webpack_require__(8);
	...
	var Memoize = function () {
	    function Memoize(hamsters) {
	        _classCallCheck(this, Memoize);
	
	        this.hamsters = hamsters;
	        this.store = this.hamsters.habitat.node ? new _NodeStore2.default() : new _WebStore2.default();
	    }
	    ...
	    _createClass(Memoize, [{
	        ...
	        key: 'applyFunc',
	        value: function applyFunc(func, task) {
	            var self = this;
	            return new Promise(function (resolve, reject) {
	                try {
...
/***/ (function(module, exports) {
	...
	var WebStore = function () {
	    function WebStore() {
	        var dbName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'hamstersjsMemoizeDB';
	        var storeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'cacheStore';
