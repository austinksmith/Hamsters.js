	  ...
	  _createClass(hamstersjs, [{
	    ...
	    */
	    ...
	    value: function hamstersTask(params, functionToRun) {
	      var taskId = this.pool.tasks.length;
	      var taskThreads = this.habitat.legacy ? 1 : params.threads || 1;
	      var taskIndexes = params.indexes || this.data.getIndexes(params.array, taskThreads);
	    ...
	    value: function scheduleTask(task, resolve, reject) {
	      ...
	      return this.pool.scheduleTask(task).then(function (results) {
	        ...
	        _this.logger.error(error.messsage, reject);
	      });
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {/* jshint esversion: 6, curly: true, eqeqeq: true, forin: true */
	  ...
	  */
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    value: function runTask(hamster, index, task, resolve, reject) {
	      ...
	      if (_habitat2.default.legacy) {
	        ...
	        this.trainHamster(this, _habitat2.default, task.count, task, hamster, resolve, reject);
	    ...
	    */
	    ...
	    key: 'processReturn',
	    value: function processReturn(habitat, message, threadId, task) {
	    ...
	    */
	    ...
	    key: 'trainHamster',
	    value: function trainHamster(pool, habitat, threadId, task, hamster, resolve, reject) {
	      var onThreadResponse = function onThreadResponse(message) {
	        ...
	        var pendingTasks = pool.pending.length !== 0;
	        if (pendingTasks) {
	    ...
	    value: function scheduleTask(task) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        while (i < task.threads) {
	          _this.hamsterWheel(task.indexes[i], task, resolve, reject);
	          i += 1;
	        }
	      });
	    }
	...
	***********************************************************************************/
	...
	var data = function () {
	  ...
	  */
	  ...
	  _createClass(data, [{
	    key: 'messageWorker',
	    value: function messageWorker(hamstersHabitat, hamster, hamsterFood) {
	      if (hamstersHabitat.reactNative) {
	    ...
	    */
	    ...
	    value: function prepareTransferBuffers(hamsterFood, buffers) {
	      Object.keys(hamsterFood).forEach(function (key) {
	        var item = hamsterFood[key];
	        if (typeof item.buffer !== 'undefined') {
	          buffers.push(item.buffer);
	        } else {
	    ...
	    */
	    ...
	    key: 'getSubArrayIndexes',
	    value: function getSubArrayIndexes(array, n) {
	      var indexes = [];
	      var i = 0;
	      var size = Math.ceil(array.length / n);
	      while (i < array.length) {
	    ...
	    */
	    ...
	    key: 'getSubArrayFromIndex',
	    value: function getSubArrayFromIndex(index, task) {
