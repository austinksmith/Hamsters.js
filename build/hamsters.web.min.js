	...
	var hamstersjs = function () {
	  ...
	  */
	  ...
	  _createClass(hamstersjs, [{
	    key: 'init',
	    value: function init(startOptions) {
	    ...
	    */
	    ...
	    value: function hamstersTask(params, functionToRun) {
	      ...
	      var taskThreads = !this.habitat.legacy && params.threads ? params.threads : 1;
	  ...
	  _createClass(wheel, [{
	    ...
	    */
	    ...
	    value: function regular() {
	      ...
	      var returnResponse = function returnResponse(rtn, buffers) {
	    ...
	    */
	    ...
	    key: 'legacy',
	    value: function legacy(hamstersHabitat, params, resolve, reject) {
	      var rtn = {
	        data: [],
	        dataType: typeof params.dataType !== "undefined" ? params.dataType : null
	      };
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    value: function processQueue(item, hamster) {
	      return this.runTask.apply(this, [hamster].concat(_toConsumableArray(item)));
	    }
	    ...
	    */
	    ...
	    key: 'fetchHamster',
	    value: function fetchHamster(threadId) {
	    ...
	    */
	    ...
	    value: function runTask(hamster, index, task, resolve, reject) {
	      ...
	      if (_habitat2.default.legacy) {
	        ...
	        this.trainHamster(this, _habitat2.default, index, task, hamster, resolve, reject);
	    ...
	    */
	    ...
	    key: 'trainHamster',
	    value: function trainHamster(pool, habitat, index, task, hamster, resolve, reject) {
	...
	***********************************************************************************/
	...
	var data = function () {
	  ...
	  */
	  ...
	  _createClass(data, [{
	    key: 'feedHamster',
	    value: function feedHamster(hamstersHabitat, hamster, hamsterFood) {
	      if (hamstersHabitat.reactNative) {
	    ...
	    */
	    ...
	    key: 'sortOutput',
	    value: function sortOutput(arr, order) {
	      switch (order) {
	        case 'desc':
	        case 'asc':
	    ...
	    */
	    ...
	    value: function addThreadOutputWithIndex(task, index, output) {
	      ...
	      if (typeof task.input.array.splice === "function") {
	        var _task$input$array;
	
	        return (_task$input$array = task.input.array).splice.apply(_task$input$array, [index.start, output.length].concat(_toConsumableArray(output)));
	      }
	      var i = 0;
	...
	var logger = function () {
	  ...
	  */
	  ...
	  _createClass(logger, [{
	    ...
	    key: 'error',
	    value: function error(message, reject) {
	    ...
	    key: 'createAndSaveStampedMessage',
	    value: function createAndSaveStampedMessage(type, message) {
	    ...
	    key: 'saveLogEntry',
	    value: function saveLogEntry(eventType, message) {
	      this.logBook[eventType].push(message);
	    }
	  }, {
	    key: 'getLogEntries',
	    value: function getLogEntries(eventType) {
	      if (eventType) {
	    ...
	    key: 'searchLogEntries',
	    value: function searchLogEntries(searchString, eventType) {
	      var finalResults = [];
	      if (eventType) {
