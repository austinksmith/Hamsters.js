	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function initializeLibrary(startOptions) {
	      ...
	      if (!this.habitat.legacy && this.habitat.persistence === true) {
	        _pool2.default.spawnHamsters(this.habitat.persistence, this.maxThreads);
	      }
	      delete this.init;
	    }
	    ...
	    */
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        _this.pool.scheduleTask(task, _this).then(function (results) {
	    ...
	    */
	    ...
	    value: function hamstersRun(params, functionToRun, onSuccess, onError) {
	      ...
	      this.pool.scheduleTask(task, this).then(function (results) {
	        ...
	        return _logger2.default.error(error.messsage, onError);
	      });
	    }
	  }]);
	  ...
	  */
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    key: 'runTask',
	    value: function runTask(array, task, scope, resolve, reject) {
	      ...
	      if (scope.habitat.legacy) {
	        ...
	        var hamster = this.grabHamster(threadId, scope.habitat);
	  ...
	  _createClass(memoizer, [{
	    ...
	    */
	    ...
	    value: function fetchItemFromCache(cacheItem) {
	      ...
	      try {
	        for (var _iterator = Object.keys(this.cache)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          key = _step.value;
