	  ...
	  _createClass(hamstersjs, [{
	    ...
	    */
	    ...
	    value: function processStartOptions(startOptions) {
	      ...
	      var habitatKeys = ['worker', 'sharedworker', 'legacy', 'webworker', 'reactnative', 'atomics', 'proxies', 'transferrable', 'browser', 'shell', 'node', 'debug', 'persistence'];
	    ...
	    */
	    ...
	    value: function trainHamster(threadId, task, hamster, persistence, resolve, reject) {
	      ...
	      function onThreadResponse(message) {
	        ...
	        task.output[threadId] = _habitat2.default.reactNative ? JSON.parse(results).data : results.data; // Save results data to output
