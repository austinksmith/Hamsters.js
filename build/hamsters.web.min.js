...
/***/ (function(module, exports) {
	...
	var Distribute = function () {
	  ...
	  _createClass(Distribute, [{
	    ...
	    key: 'distributeTask',
	    value: function distributeTask(task, hamsterFood) {
	      var _this5 = this;
	
	      return new Promise(function (resolve, reject) {
	        var targetClient = _this5.fetchDistributedClient();
	        var messageId = _this5.generateUniqueId();
	        ...
	        _this5.pendingPromises[messageId] = { resolve: resolve, reject: reject };
	
	        _this5.sendData({ targetClient: targetClient, data: subTask });
	      });
	    }
	  }, {
	    key: 'sendData',
	    ...
	    value: function receiveChannelCallback(event, targetClient) {
	      ...
	      if (!this.sendChannels[targetClient]) {
	        ...
	        sendChannel.onopen = function () {
	          _this7.onSendChannelStateChange(targetClient);
	        };
	        sendChannel.onclose = function () {
	          _this7.onSendChannelStateChange(targetClient);
	        };
