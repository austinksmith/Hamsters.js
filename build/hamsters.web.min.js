...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	var hamstersjs = function () {
	  ...
	  */
	  function hamstersjs() {
	    ...
	    this.version = _version.hamstersVersion.current;
	  ...
	  */
	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function initializeLibrary(startOptions) {
	      ...
	      if (!_habitat.hamstersHabitat.legacy && _habitat.hamstersHabitat.persistence === true) {
	        _pool.hamstersPool.spawnHamsters(_habitat.hamstersHabitat.maxThreads);
	      }
	      _logger.hamstersLogger.info('Initialized using up to ' + _habitat.hamstersHabitat.maxThreads + ' threads.');
	      delete this.init;
	    }
	    ...
	    */
	    ...
	    value: function processStartOptions(startOptions) {
	      ...
	      if (typeof startOptions !== 'undefined') {
	        ...
	        var habitatKeys = ['worker', 'sharedworker', 'legacy', 'webworker', 'reactnative', 'atomics', 'proxies', 'transferrable', 'browser', 'shell', 'node', 'debug', 'persistence', 'importscripts', 'maxthreads', 'messageport'];
	        var key = null;
	        ...
	        try {
	          for (var _iterator = Object.keys(startOptions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            if (habitatKeys.indexOf(key.toLowerCase()) !== -1) {
	              _habitat.hamstersHabitat[key] = startOptions[key];
	            } else {
	      ...
	      if (typeof _habitat.hamstersHabitat['Worker'] === 'function' && !legacyMode) {
	        _habitat.hamstersHabitat.legacy = false;
	      }
	      // Finished initializing, add methods & imports
	      this.habitat = _habitat.hamstersHabitat;
	      this.maxThreads = _habitat.hamstersHabitat.maxThreads;
	      this.data = _data.hamstersData;
	      this.logger = _logger.hamstersLogger;
	      this.memoizer = _memoizer.hamstersMemoizer;
	    ...
	    */
	    ...
	    value: function hamstersTask(params, functionToRun) {
	      var newHamstersTaskId = _pool.hamstersPool.tasks.length;
	      var newHamstersTask = {
	    ...
	    value: function scheduleTask(task, resolve, reject) {
	      _pool.hamstersPool.scheduleTask(task).then(function (results) {
	        return resolve(results);
	      }).catch(function (error) {
	        return _logger.hamstersLogger.error(error.messsage, reject);
	      });
	    }
	    ...
	    */
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        var task = _this.hamstersTask(params, functionToRun);
	    ...
	    */
	    ...
	    value: function hamstersRun(params, functionToRun, onSuccess, onError) {
	      var task = this.hamstersTask(params, functionToRun);
	...
	var hamsters = exports.hamsters = new hamstersjs();
	...
	***********************************************************************************/
	...
	var version = function () {
		...
		_createClass(version, [{
			key: 'getHamstersVersion',
			value: function getHamstersVersion() {
	...
	var hamstersVersion = exports.hamstersVersion = new version();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	exports.hamstersHabitat = undefined;
	...
	var habitat = function () {
	  ...
	  */
	  function habitat() {
	    ...
	    this.legacyWheel = _wheel.hamstersWheel.legacy;
	  ...
	  _createClass(habitat, [{
	    ...
	    */
	    ...
	    value: function supportsSharedWorkers() {
	      var supports = false;
	      try {
	        var workerBlob = _data.hamstersData.generateBlob();
	    ...
	    */
	    ...
	    value: function selectHamsterWheel() {
	      ...
	      if (this.webWorker) {
	        return _wheel.hamstersWheel.worker;
	      }
	      if (this.node) {
	        return './node_modules/hamsters.js/build/common/hamstersWheel.js';
	      }
	      return _data.hamstersData.generateWorkerBlob(_wheel.hamstersWheel.regular);
	    }
	  }]);
	...
	var hamstersHabitat = exports.hamstersHabitat = new habitat();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	exports.hamstersData = undefined;
	  ...
	  */
	  ...
	  _createClass(data, [{
	    ...
	    value: function messageWorker(hamster, hamsterFood) {
	      if (_habitat.hamstersHabitat.reactNative) {
	        return hamster.postMessage(JSON.stringify(hamsterFood));
	      }
	      if (_habitat.hamstersHabitat.ie10) {
	        return hamster.postMessage(hamsterFood);
	      }
	      if (_habitat.hamstersHabitat.webWorker) {
	        return hamster.port.postMessage(hamsterFood);
	      }
	      if (_habitat.hamstersHabitat.node) {
	        return hamster.postMessage(hamsterFood);
	      }
	    ...
	    */
	    ...
	    value: function processDataType(dataType, buffer) {
	      if (_habitat.hamstersHabitat.transferrable) {
	    ...
	    */
	    ...
	    value: function locateBlobBuilder() {
	      ...
	      return _logger.hamstersLogger.error('Environment does not support data blobs!');
	    }
	    ...
	    */
	    ...
	    value: function aggregateThreadOutputs(input, dataType) {
	      if (!dataType || !_habitat.hamstersHabitat.transferrable) {
	...
	var hamstersData = exports.hamstersData = new data();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	exports.hamstersLogger = undefined;
	  ...
	  */
	  ...
	  _createClass(logger, [{
	    ...
	    value: function generateTimeStampedMessage(type, message) {
	      var record = 'Hamsters.js v' + _version.hamstersVersion.current + ' ' + type + ': ' + message + ' @ ' + Date.now();
	...
	var hamstersLogger = exports.hamstersLogger = new logger();
...
/***/ (function(module, exports) {
	...
	***********************************************************************************/
	  ...
	  _createClass(wheel, [{
	      ...
	      addEventListener('connect', function (incomingConnection) {
	        ...
	        port.addEventListener('message', function (incomingMessage) {
	          ...
	          if (params.importScripts) {
	            _this.importScripts(params.importScripts);
	          }
	    ...
	    */
	    ...
	    value: function regularScaffold() {
	      ...
	      var typedArrayFromBuffer = function typedArrayFromBuffer(dataType, buffer) {
	        var types = {
	          'uint32': Uint32Array,
	          'uint16': Uint16Array,
	          'uint8': Uint8Array,
	      ...
	      var prepareReturn = function prepareReturn(returnObject) {
	      ...
	      var prepareTransferBuffers = function prepareTransferBuffers(hamsterFood) {
	        var key = void 0,
	            buffers = [];
	        for (key in hamsterFood) {
	          if (hamsterFood.hasOwnProperty(key)) {
	      ...
	      this.onmessage = function (incomingMessage) {
	        ...
	        if (params.importScripts) {
	          _this2.importScripts(params.importScripts);
	        }
	...
	var hamstersWheel = exports.hamstersWheel = new wheel();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	exports.hamstersPool = undefined;
	  ...
	  */
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    key: 'grabHamster',
	    value: function grabHamster(threadId) {
	      if (_habitat.hamstersHabitat.persistence) {
	    ...
	    */
	    ...
	    value: function spawnHamster() {
	      var newWheel = _habitat.hamstersHabitat.selectHamsterWheel();
	      if (_habitat.hamstersHabitat.webWorker) {
	        return new _habitat.hamstersHabitat.SharedWorker(newWheel, 'SharedHamsterWheel');
	      }
	      if (_habitat.hamstersHabitat.node && typeof _habitat.hamstersHabitat.parentPort !== 'undefined') {
	        return new _habitat.hamstersHabitat.Worker();
	      }
	      return new _habitat.hamstersHabitat.Worker(newWheel);
	    }
	    ...
	    */
	    ...
	    key: 'runTask',
	    value: function runTask(hamster, array, task, resolve, reject) {
	      ...
	      if (_habitat.hamstersHabitat.legacy) {
	        _habitat.hamstersHabitat.legacyWheel(hamsterFood, resolve, reject);
	      } else {
	        this.trainHamster(task.count, task, hamster, resolve, reject);
	        _data.hamstersData.feedHamster(hamster, hamsterFood);
	      }
	    ...
	    */
	    ...
	    key: 'hamsterWheel',
	    value: function hamsterWheel(array, task, resolve, reject) {
	      if (_habitat.hamstersHabitat.maxThreads === this.running.length) {
	        return this.addWorkToPending(array, task, resolve, reject);
	      }
	      var hamster = this.grabHamster(this.running.length);
	    ...
	    */
	    ...
	    value: function returnOutputAndRemoveTask(task, resolve) {
	      var output = _data.hamstersData.getOutput(task);
	      if (task.sort) {
	        output = _data.hamstersData.sortOutput(output, task.sort);
	      }
	    ...
	    */
	    ...
	    value: function trainHamster(threadId, task, hamster, resolve, reject) {
	      ...
	      function onThreadResponse(message) {
	        ...
	        } else if (!_habitat.hamstersHabitat.persistence && !_habitat.hamstersHabitat.webWorker) {
	          hamster.terminate(); //Kill the thread only if no items waiting to run (20-22% performance improvement observed during testing, repurposing threads vs recreating them)
	        }
	      }
	      // Handle error response from a thread
	      function onThreadError(error) {
	        _logger.hamstersLogger.errorFromThread(error, reject);
	      }
	      ...
	      } else if (_habitat.hamstersHabitat.node && typeof _habitat.hamstersHabitat.parentPort !== 'undefined') {
	        hamster.parentPort.onmessage = onThreadResponse;
	        _habitat.hamstersHabitat.parentPort.onmessageerror = onThreadError;
	        _habitat.hamstersHabitat.onerror = onThreadError;
	      } else {
	    ...
	    value: function scheduleTask(task) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        if (task.input.array && task.threads !== 1) {
	          threadArrays = _data.hamstersData.splitArrays(task.input.array, task.threads); //Divide our array into equal array sizes
	        }
	        var i = 0;
	        while (i < task.threads) {
	          if (threadArrays && task.threads !== 1) {
	            _this.hamsterWheel(threadArrays[i], task, resolve, reject);
	          } else {
	            _this.hamsterWheel(task.input.array, task, resolve, reject);
	          }
	          i += 1;
	        }
	      });
	...
	var hamstersPool = exports.hamstersPool = new pool();
...
/***/ (function(module, exports) {
	...
	***********************************************************************************/
	...
	var hamstersMemoizer = exports.hamstersMemoizer = new memoizer();
