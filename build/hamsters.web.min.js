...
/***/ (function(module, exports, __webpack_require__) {
	...
	***********************************************************************************/
	...
	var _wheel = __webpack_require__(8);
	  ...
	  _createClass(hamstersjs, [{
	    ...
	    */
	    ...
	    value: function processStartOptions(startOptions) {
	      ...
	      var habitatKeys = ['worker', 'sharedworker', 'legacy', 'webworker', 'reactnative', 'atomics', 'proxies', 'transferrable', 'browser', 'shell', 'node'];
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    value: function spawnHamster(wheel, workerURI) {
	      ...
	      if (_habitat2.default.node || _habitat2.default.reactNative || _habitat2.default.ie10) {
