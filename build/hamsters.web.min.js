...
/***/ (function(module, exports) {
	...
	var Distribute = function () {
	  ...
	  _createClass(Distribute, [{
	      ...
	      this.connectionTargets.forEach(function (targetClient) {
	        if (!_this3.remoteConnections[targetClient]) {
	          ...
	          localConnection.oniceconnectionstatechange = function () {
	            _this3.onConnectionStateChange(targetClient);
	          };
	    ...
	    value: function handleOffer(data) {
	      ...
	      if (!this.remoteConnections[targetClient]) {
	        ...
	        remoteConnection.oniceconnectionstatechange = function () {
	          _this4.onConnectionStateChange(targetClient);
	        };
	
	        remoteConnection.onconnectionstatechange = function () {
	          _this4.onConnectionStateChange(targetClient);
	        };
	    ...
	    value: function removeConnection(targetClient) {
	    ...
	    value: function receiveChannelCallback(event, targetClient) {
	      ...
	      receiveChannel.onopen = function () {
	        _this6.onReceiveChannelStateChange(targetClient);
	      };
	    ...
	    value: function onSendChannelStateChange(targetClient) {
	      var sendChannel = this.sendChannels[targetClient];
	      var readyState = sendChannel ? sendChannel.readyState : 'unknown';
	    ...
	    value: function onReceiveChannelStateChange(targetClient) {
	      ...
	      var readyState = receiveChannel ? receiveChannel.readyState : 'unknown';
	    ...
	    value: function onConnectionStateChange(targetClient) {
	      var connection = this.remoteConnections[targetClient];
	      var state = connection ? connection.connectionState : 'unknown';
