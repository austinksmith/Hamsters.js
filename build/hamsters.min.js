	...
	*/
	...
	var hamsters = function () {
	  ...
	  _createClass(hamsters, [{
	    ...
	    value: function subArrayFromIndex(array, start, end) {
	      if (array.slice) {
	    ...
	    value: function prepareAndSaveTaskOptions(params, functionToRun) {
	      var taskOptions = {
	        inputParams: params,
	    ...
	    key: 'runHamsters',
	    value: function runHamsters(params, functionToRun) {
	      ...
	      var task = this.prepareAndSaveTaskOptions(params, functionToRun);
