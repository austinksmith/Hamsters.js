	...
	var hamstersjs = function () {
	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function initializeLibrary(startOptions) {
	      ...
	      _pool2.default.spawnHamsters(this.persistence, _pool2.default.selectHamsterWheel(), this.maxThreads);
	      delete this.init;
	    }
	  }, {
	    ...
	    value: function legacyHamsterWheel(threadId, task, resolve, reject) {
	      ...
	      var dataArray = _data2.default.arrayFromIndex(task.input.array, task.indexes[threadId]);
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        _this.pool.registerTask(task);
	        _this.pool.scheduleTask(task, _this.persistence, scaffold, _this.maxThreads).then(function (results) {
	          resolve(results);
	    ...
	    value: function hamstersRun(params, functionToRun, onSuccess, onError) {
	      ...
	      this.pool.scheduleTask(task, this.persistence, scaffold, this.maxThreads).then(function (results) {
	        onSuccess(results);
	      }).catch(function (error) {
	...
	*/
	...
	var data = function () {
	  ...
	  _createClass(data, [{
	    ...
	    key: 'prepareFunction',
	    value: function prepareFunction(functionBody, habitat) {
	      if (!habitat.legacy) {
	...
	var pool = function () {
	  ...
	  _createClass(pool, [{
	    ...
	    value: function registerTask(task) {
	      var index = this.tasks.push(task.id);
	    ...
	    key: 'hamsterWheel',
	    value: function hamsterWheel(array, task, persistence, wheel, resolve, reject) {
	      ...
	      _data2.default.feedHamster(hamster, this.prepareMeal(array, task));
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        while (i < task.threads) {
	          if (threadArrays && task.threads !== 1) {
	            _this.hamsterWheel(threadArrays[i], task, persistence, wheel, resolve, reject);
	          } else {
	            _this.hamsterWheel(task.input.array, task, persistence, wheel, resolve, reject);
	          }
	          i += 1;
	        }
	      });
