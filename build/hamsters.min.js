	...
	*/
	...
	var pool = function () {
	  ...
	  _createClass(pool, [{
	    ...
	    key: 'hamsterWheel',
	    value: function hamsterWheel(task, persistence, wheel, resolve, reject) {
	      var threadId = this.running.length;
	      if (this.maxThreads === threadId) {
	        return this.queueWork(task, threadId, resolve, reject);
	      }
	      var hamsterFood = _data2.default.prepareMeal(task, threadId);
	    ...
	    value: function scheduleTask(task, persistence, wheel, maxThreads) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        while (i < task.threads) {
	          _this.hamsterWheel(task, persistence, wheel, resolve, reject);
	          i += 1;
	        }
	      });
	    }
