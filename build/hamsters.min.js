...
},{"./cache/memoizer":2,"./environment/setup-environment":11,"./pool/thread-pool":18,"./processor/hamster-worker":19,"./tools/hamster-tools":30,"./wheel/data/create-blob":33,"./wheel/hamster-wheel":36,"./wheel/task/execute-task":38,"./wheel/task/new-task":39}],17:[function(require,module,exports){
/*
* Title: Hamsters.js
* Description: Javascript library to add multi-threading support to javascript by exploiting concurrent web workers
* Author: Austin K. Smith
