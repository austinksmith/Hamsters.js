	  ...
	  _createClass(hamstersjs, [{
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        _this.pool.scheduleTask(newTask, _this.persistence, _this.wheel, _this.maxThreads).then(function (results) {
	          resolve(results);
	    ...
	    value: function hamstersRun(params, functionToRun, onSuccess, onError) {
	      var newTask = new this.hamstersTask(params, functionToRun, this);
